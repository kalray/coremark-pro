...
TOOLS	= /work1/lthevenoux/csw/devimage/toolchain_default/toolroot/usr/local/k1rdtools/
# For Solaris
#TOOLS	= /usr/local
# For Solaris
...
AS		= $(TOOLS)/bin/k1-cos-as

LD		= $(TOOLS)/bin/k1-cos-gcc
EXEOUT	= -o
EXE		= .exe

AR		= $(TOOLS)/bin/k1-cos-ar
LIBTYPE	= .a
LIBOUT	= 
